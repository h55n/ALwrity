...
const CodeOfConductPage: React.FC = () => (
  <LegalPageLayout
    ...
    metaDescription="ALwrity Code of Conduct — community standards for contributors, users, and partners of our open-source AI marketing platform."
  ...
  >
    ...
    <p>
      ...
      <a href="mailto:info@alwrity.com">info@alwrity.com</a>. All complaints will be reviewed and
    ...
    <p>
      <strong>Consequence:</strong> A warning with consequences for continued behavior. No interaction
      with the people involved, including unsolicited interaction with those enforcing the Code of
      Conduct, for a specified period of time. This includes avoiding interactions in community spaces
      as well as external channels like social media. Violating these terms may lead to a temporary or
      permanent ban.
    </p>
    ...
    <p>
      ...
      <a href="https://www.contributor-covenant.org/version/2/0/code_of_conduct.html" target="_blank" rel="noopener noreferrer">
        Contributor Covenant
      </a>
      , version 2.0. Community Impact Guidelines were inspired by{' '}
      ...
      <a href="https://www.contributor-covenant.org/faq" target="_blank" rel="noopener noreferrer">
